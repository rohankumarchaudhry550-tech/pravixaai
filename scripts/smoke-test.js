...
async function main() {
  ...
  try {
    const publicPaths = [
      ...
      '/services',
      '/portfolio',
      '/portfolio/sabbath-app',
      '/portfolio/electropayroll',
      '/portfolio/alrayyan-tv',
      '/portfolio/space-launch-schedule',
      '/portfolio/pismitra',
      '/portfolio/exicube-taxi-app-theme',
      '/portfolio/electro-go',
      '/portfolio/8-poure',
      '/portfolio/osteo',
      '/portfolio/snowy-delights',
      '/portfolio/aasthika-pharmacy',
      '/careers',
      '/contact',
      '/book-demo',
      '/login',
